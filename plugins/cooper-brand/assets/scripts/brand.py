...
TAGLINE_HTML = "We turn Web3 ideas <em>into products people use.</em>"   # the cover line of the Figma file
LINKS = [("Website", "cooperlabs.xyz"), ("X", "@cooperlabs"), ("Telegram", "@jeanbrasse")]
